...
## How to Setup Chargeblast Account under 5 mins

<iframe src="https://www.youtube.com/embed/bZuznhrpDUk" title="YouTube video player" frameborder="0" className="w-full aspect-video rounded-xl" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />

## <Icon icon="rocket" iconType="solid" size="24" /> Getting Started

Chargeblast offers three core services to prevent chargebacks:

<CardGroup cols={3}>
  <Card title="Alerts" icon="bell" href="/guides/alerts-implementation">
    Intercept disputes via CDRN & Ethoca before they become chargebacks.
  </Card>

  <Card title="Digital Receipts" icon="receipt" href="/guides/deflections-implementation">
    Show transaction details to cardholders to reduce confusion.
  </Card>

  <Card title="Deflections" icon="shield-check" href="/guides/deflections-implementation">
    Block chargebacks automatically with CE3.0 and First Party Trust.
  </Card>
</CardGroup>

<Info>
  New to Chargeblast? Start with the [Implementation Overview](/guides/implementation-overview) to understand your integration options.
</Info>
...
- **CDRN:** CDRN is an issuer based product offered by VISA. CDRN focuses on VISA related transactions though will still deploy for Mastercard and other schemes.
