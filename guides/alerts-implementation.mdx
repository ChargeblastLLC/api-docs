...
<Tabs>
  <Tab title="Push Data (Recommended)">
    ...
    4. **Action alerts** via one of two methods:
       - Expose a [Refund Endpoint](/api-reference/getting-started/refund-endpoint) for automatic processing
       - Call the [Update Alert](/api-reference/alerts/update-alert) endpoint manually
    ...
    <Steps>
      ...
      <Step title="(Optional) Expose Refund Endpoint">
        For fully automated refunds, expose a [Refund Endpoint](/api-reference/getting-started/refund-endpoint) that Chargeblast calls when alerts match.
        
        Alternatively, process refunds manually and call the [Update Alert](/api-reference/alerts/update-alert) endpoint.
      </Step>
    </Steps>
...
- [Refund Endpoint](/api-reference/getting-started/refund-endpoint) — Automated refund processing
