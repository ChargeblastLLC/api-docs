...
<Tabs>
  ...
  <Tab title="Pull Data">
    **Chargeblast forwards requests to you. You handle matching.**
    ...
    - For digital receipts and deflections, implement the [digital receipt lookup HTTPS endpoint](/guides/digital-receipt-lookup) (POST, authenticated with lookup key and optional HMAC; **1.5s SLA**)
